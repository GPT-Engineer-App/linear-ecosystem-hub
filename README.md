...
**Project**: linear-ecosystem-hub 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**:  Build an Linear clone
Landing page about Linear value props
User has teams, that has projects, projects have issues, issues have statuses
Projects also have documents
Projects have milestones (which can be viewed in a gant-like fashion) 
...
```sh
git clone https://github.com/GPT-Engineer-App/linear-ecosystem-hub.git
cd linear-ecosystem-hub
npm i
